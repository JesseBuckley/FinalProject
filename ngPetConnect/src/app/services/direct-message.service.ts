...
//     return this.http.get<DirectMessage[]>(`${this.url}api/directMessages`, this.getHttpOptions()).pipe(
//         catchError((err: any) => {
...
//     return this.http.get<DirectMessage>(`${this.url}api/directMessages/${dmId}`, this.getHttpOptions()).pipe(
//         catchError((err: any) => {
...
//   create(directMessage: DirectMessage, recipientId: number): Observable<DirectMessage> {
//     return this.http.post<DirectMessage>(`${this.url}api/users/${recipientId}/directMessages`, directMessage, this.getHttpOptions()
//       ).pipe(
//         catchError((err: any) => {
...
//   update(dmId: number,directMessage: DirectMessage): Observable<DirectMessage> {
//     return this.http.put<DirectMessage>(`${this.url}api/users/${dmId}/directMessages`, directMessage, this.getHttpOptions()
//       ).pipe(
//         catchError((err: any) => {
...
//     return this.http.delete<void>(`${this.url}api/users/${dmId}/directMessages`, this.getHttpOptions()).pipe(
//         catchError((err: any) => {
